...
<body>
    ...
    <table class="tbl-base">
        <tbody class="">
            <tr class="">
                <td class="wd50 align-middle fs-12"><strong>Importe Total Egresos:</strong></td>
                <td class="wd50 align-middle fs-12 text-end pe-3"><?= formatMoney($data['importe_total_egresos']); ?></td>
    ...
    <div class="mt-3 text-left wd100">
        <h5>Detalle de Registro de Egresos (Gastos)</h5>
    </div>

    <table class="tbl-detalle-egresos mt-2">
        <thead>
            <tr>
                <th class="align-middle text-center" style="width: 10%; border-radius: 5px 0 0 0;">FECHA PAGO</th>
                <th class="align-middle text-center" style="width: 10%; border-radius: 0 0 0 0;">CLASIFICACIÓN</th>
                <th class="align-middle text-center" style="width: 10%; border-radius: 0 0 0 0;">PROVEEDOR</th>
                <th class="align-middle text-center" style="width: 10%; border-radius: 0 0 0 0;">FECHA FACTURA</th>
                <th class="align-middle text-center" style="width: 10%; border-radius: 0 0 0 0;">FOLIO</th>
                <th class="align-middle text-center" style="width: 40%; border-radius: 0 5px 0 0;">DESCRIPCIÓN</th>
                <th class="align-middle text-center" style="width: 10%; border-radius: 0 5px 0 0;">IMPORTE</th>
            </tr>
        </thead>
        <tbody>
            <?php
            ...
            for ($i = 0; $i < count($arrEgresos); $i++) { ?>
                <tr>
                    <td style="width: 10%;" class="text-center"><?= $arrEgresos[$i]['fecha_pago']; ?></td>
                    <td style="width: 10%;" class="text-start"><?= $arrEgresos[$i]['clasificacion']; ?></td>
                    <td style="width: 10%;" class="text-center"><?= $arrEgresos[$i]['proveedor']; ?></td>
                    <td style="width: 10%;" class="text-center"><?= $arrEgresos[$i]['fecha_docto']; ?></td>
                    <td style="width: 10%;" class="text-center"><?= $arrEgresos[$i]['folio_nota']; ?></td>
                    <td style="width: 40%;" class="text-start"><?= $arrEgresos[$i]['descripcion']; ?></td>
                    <td style="width: 10%;" class="text-end pe-1"><?= formatMoney($arrEgresos[$i]['importe']); ?></td>
                </tr>
            <?php } ?>
        </tbody>
    </table>
