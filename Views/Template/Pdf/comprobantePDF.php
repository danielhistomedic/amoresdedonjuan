...
<body>
    ...
    <div class="pos-r" style="width: 89%;   
        ...
        <!-- subrayado fecha -->
        <span style="position: absolute; top: 134px; left: 180px;">______</span>
        <span style="position: absolute; top: 134px; left: 275px;">______________</span>
        <span style="position: absolute; top: 134px; left: 440px;">_______</span>
        <!-- subrayado fecha  -->

        <!-- nombre residente -->
        <span style="position: absolute; top: 200px; left: 15px;">___________________________________________________________________</span>
        <!-- nombre residente -->

        <!-- domicilio -->
        <span style="position: absolute; top: 234px; left: 190px;">____________________________</span>
        <span style="position: absolute; top: 234px; left: 435px;">________</span>
        <span style="position: absolute; top: 234px; left: 545px;">________</span>
        <span style="position: absolute; top: 234px; left: 655px;">______</span>
        <!-- domicilio -->


        <!-- importe-->
        <span style="position: absolute; top: 271px; left: 155px;">_____________</span>
        <!-- importe -->


        <!-- importe con letra-->
        <span style="position: absolute; top: 310px; left: 195px;">______________________________________</span>
        <!-- importe con letra -->
        ...
        <table class="mt-0">
            <tbody>
                <tr>
                    <td class="text-start wd50 fs-18 text-bold">RECIBO DE COBRO</td>
                    <td class="text-end wd50 fs-18 text-bold">RECIBO <span style="color:red;">No.</span></td>
                </tr>
            </tbody>
        </table>
        <table class="mt-2">
            <tbody>
                <tr>
                    <td class="wd25 text-start" style="padding-left: 30px;"> <img src="<?= media(); ?>/images/brand/logo.png" alt="logo" style="width: 80px;"> </td>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="wd20" align="center">
                        <img class="ms-4" src="<?= media(); ?>/files/temp/qr.png" alt="logo" style="width: 80px;">
                    </td>
                </tr>
            ...
            <tbody>
                <tr>
                    <td class="wd50 fs-16" align="left">
                        <span style="font-weight:bold; margin-right: 5px;">RECIBIÓ:</span>
