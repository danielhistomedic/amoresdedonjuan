                    ...
                    <div class="tile-body">
                        ...
                        <form id="formUsuario" name="formUsuario" class="form-horizontal">
                            ...
                            <div class="tile-footer">
                                <button id="btnActionForm" class="btn btn-primary bg-primary-gradient" type="submit">
                                    <i class="fa fa-fw fa-lg fa-check-circle"></i>
                                    <span id="btnText">Guardar</span>
                                </button>
                                <a class="btn btn-secondary bg-warning-gradient  ml-1" href="#" data-dismiss="modal">
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary bg-warning-gradient " data-dismiss="modal">Cerrar</button>
            </div>
