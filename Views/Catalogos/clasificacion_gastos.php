    ...
    <div class="container">
        ...
        <div class="page-header">
            ...
            <div class="ms-auto pageheader-btn">
                <btn class="btn btn-secondary bg-warning-gradient  btn-icon text-white me-2 crear_editar_clasif_gastos <?= $disabled = ($data['permisosMod']['c']) ? '' : 'disabled'; ?>" id="btnNuevaClasifGastos" data-animation="fadeInDown">
                    <span>
            ...
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    <div class="card-header bg-light">
                        <h4 class="card-title">
                            <i class="fa-regular fa-folder-gear text-secondary text-secondary-shadow fa-lg me-1"></i> Registro de Clasificación de Gastos
                        </h4>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <!-- Lista -->
                        <div class="" id="list_clasificacion_gastos">

                            <div class="row">

                                <!-- Subtitulos Lista de Clasificación de Gastos Registrados -->
                                <div class="form-group col-12 mt-2">
                                    <div class="border-bottom-subtitle subtitulos_panel">
                                        <p class="mb-0 fw-semibold fs-14"><i class="fa-regular fa-bars-staggered text-secondary text-secondary-shadow fs-16"></i> Lista de Clasificación de Gastos Registrados.</p>
                                    </div>
                                </div>
                                <!-- Fin Lista de Clasificación de Gastos Registrados -->

                                <div class="form-group col-12  mt-1">

                                    <!-- Tabla de Registros -->
                                    <div class="table-responsive">
                                        <table id="tableClasificacionGastos" class="table table-striped table-bordered table-hover tabla-sys" style="width:100%">
                        ...
                        <!-- Crear/Editar Datos -->
                        <div class="" id="crear_editar_clasif_gastos" style="display: none;">

                            <form name="formClasificacionGastos" id="formClasificacionGastos">

                                <div class="row">

                                    <div class="form-group col-12 col-sm-4">
                                        <label for="inputClasifGastos" class="form-label">Clasificación:</label>
                                        <input type="text" class="form-control inputForm100" name="inputClasifGastos" id="inputClasifGastos" placeholder="Ingrese Clasificación">
                                    </div>

                                    <div class="form-group col-12 mb-0 mt-3">

                                        <input type="hidden" class="" name="inputClasifGastosId" id="inputClasifGastosId" value="">
                                        ...
                                        <div class="d-flex justify-content-start align-items-center d-flex-pacientes-inicio">
                                            ...
                                            <button type="submit" class="<?php
                                                                            if ($data['permisosMod']['c'] == 0 && $data['permisosMod']['u'] == 0) {
                                                                                echo 'disabled';
                                                                            } ?> btn btn-secondary bg-warning-gradient  btn-guardar-form d-flex justify-content-center align-items-center" id="btnGuardarClasifGastos">
                                            ...
                                            <button type="button" class="btn btn-danger bg-danger-gradient btn-cancelar-form d-flex justify-content-center align-items-center list_clasificacion_gastos btnCancelar_ClasifGastos" data-animation="fadeIn">
                                                <div class="d-flex justify-content-center align-items-center">
                        ...
                        <!-- Vista de Datos -->
                        <div class="" id="view_clasificacion_gastos" style="display: none;">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-12 mb-0">
                                    <div class="d-flex justify-content-start align-items-center d-flex-pacientes-inicio">
                                        <button type="button" class="btn btn-danger bg-danger-gradient btn-cancelar-form-only d-flex justify-content-center align-items-center list_clasif_gastos btnCancelar_ClasifGastos" data-animation="fadeIn">
                                            <div class="d-flex justify-content-center align-items-center">
                                                <i class="fa-regular fa-rotate-left fa-fw fa-lg me-1"></i>
                                                <span class="">Regresar a Listado</span>
                                                <i class="fa-thin fa-loader fa-spin fa-fw fa-lg ms-2" style="display:none;"></i>
