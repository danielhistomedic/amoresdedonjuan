                    ...
                    <div class="card-body">
                        ...
                        <div class="" id="list_estado_resultados">
                                ...
                                <div class="form-group col-12 col-sm-6">
                                    ...
                                    <div class="row">
                                        ...
                                        <div id="opciones-filtro" class="form-group col-12 collapse show ">
                                            ...
                                            <form name="formMostrarReporteIngresos" id="formMostrarReporteIngresos">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-12">
                                                        <div class="d-flex justify-content-start align-items-center d-flex-pacientes-inicio">
                                                            <button type="submit" class="btn btn-secondary bg-warning-gradient  btn-guardar-form d-flex justify-content-center align-items-center" id="btnMostarReporteIngresos">
                                    ...
                                    <div class="row">
                                        ...
                                        <div id="resumen-filtro" class="form-group col-12 collapse show ">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-12 m-0 mt-1">
                                                    ...
                                                    <div class="form-label mt-0 col-12 d-flex justify-content-start align-items-start">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-6">
                                                                <label class="form-label fs-14 fw-bold text-primary">Importe Total Ingresos: <span id="lblFechaSaldoAnterior"></span> </label>
                                                                <h5 class="fs-14 text-muted" id="lblTotalIngresos">$ 0.00</h5>
                                                            </div>
                                                ...
                                                <div class="form-group col-12">
                                                    <div class="d-flex justify-content-start align-items-center d-flex-pacientes-inicio">
                                                        <button type="submit" class="btn btn-secondary bg-warning-gradient  btn-guardar-form d-flex justify-content-center align-items-center <?= $disabled = ($data['permisosMod']['p_excel']) ? '' : 'disabled'; ?>" id="btnImprimirReporteIngresos">
                                                            <div class="d-flex justify-content-center align-items-center">
                            ...
                            <div class="row">
                                ...
                                <!-- Subtitulos Lista de Ingresos del Periodo -->
                                ...
                                <!-- Fin Lista de Ingresos del Periodo -->
                                <div id="panel-ingresos" class="collapse show col-12">
                                    <div class="form-group col-12  mt-1">

                                        <!-- Tabla de Registros -->
                                        <div class="table-responsive">
                                            <table id="tableReporteIngresos" class="table table-striped table-bordered table-hover tabla-sys" style="width:100%">
                            ...
                            <!-- Informe de Recibos de Pago Anteriores -->
                            <div class="row">

                                <!-- Subtitulos Lista de Recibos Aplicados de Fechas Anterires -->
                                <div class="form-group col-12 mt-2">
                                    <div class="border-bottom-subtitle subtitulos_panel collapse-icon" style="cursor: pointer;" data-bs-toggle="collapse" data-bs-target="#panel-recibos-anteriores" aria-expanded="false" aria-controls="panel-recibos-anteriores">
                                        <p class="mb-0 fw-semibold fs-14"><i class="fa-regular fa-bars-staggered text-primary text-primary-shadow fs-20 me-2"></i><span id="title-list">Lista de Recibos Aplicados de Fechas Anteriores. <i class="collapse-down-ingresos fa-regular fa-angles-up"></i></span></p>
                                    </div>
                                </div>
                                <!-- Fin Lista de Recibos Aplicados de Fechas Anterires -->
                                <div id="panel-recibos-anteriores" class="collapse show col-12">
                                    <div class="form-group col-12  mt-1">
