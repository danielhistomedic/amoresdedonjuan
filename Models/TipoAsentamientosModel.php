...
/**
 * Clase TipoAsentamientosModel
 */
class TipoAsentamientosModel extends Mysql
{
    ...
    /**
     * Método Constructor de TipoAsentamientosModel.
    ...
    /**
     * Obtiene la lista del catálogo de tipo_asentamientos.
     * 
     * @return array $request
     * 
     */
    public function selectTipoAsentamientos(): array
    {
        ...
        try {
            ...
            $sql = "SELECT ";
            $sql .= "cat.*,  us.usuario ";
            $sql .= "FROM tipo_asentamientos cat ";
